...
<div id="navigation">
	<div class="container-fluid">
		...
		<ul class='main-nav'>
			<li  id="vehicle"><a href="../vehicle/load.action"> <i class="icon-home"></i> <span>Véhicule</span>
			</a></li>
			<li id="employee"><a href="../employee/load.action"> <i class="icon-home"></i> <span>Employé</span>
			</a></li>
