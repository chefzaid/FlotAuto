	...
	<div class="container-fluid">
		<div class="page-header">
			...
			<div class="pull-right">
				<ul class="minitiles">
					<li class='teal'><a href="#"><i class="icon-inbox"></i> </a></li>
					<li class='red'><a href="#"><i class="icon-cogs"></i> </a></li>
					<li class='lime'><a href="#"><i class="icon-globe"></i> </a></li>
				</ul>
				<ul class="stats">
		...
		<div class="breadcrumbs">
			<ul>
				...
				<li><a href="index.html">Véhicule</a></li>
			</ul>
