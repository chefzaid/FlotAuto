	...
	<div id="left">
		...
		<div class="subnav">
			...
			<ul class="subnav-menu">
				...
				<li><a href="#">Achat/Location</a>
				</li>
				<li><a href="#">Conducteurs</a>
				</li>
			</ul>
		</div>
		<div class="subnav">
			...
			<ul class="subnav-menu">
				<li><a href="#">Programme d'entretien</a>
				</li>
				<li><a href="#">Ordre de travail</a>
				</li>
				<li><a href="#">Entretiens effectués</a>
				</li>
				<li><a href="#">Pièces</a>
				</li>
				<li><a href="#">Pleins d'essence</a>
				</li>
				<li><a href="#">Pneus</a>
				</li>
				<li><a href="#">Autres frais</a>
				</li>
				<li><a href="#">Odomètre</a>
				</li>
			</ul>
		</div>
		<div class="subnav">
			<div class="subnav-title">
				<a href="#" class='toggle-subnav'><i class="icon-angle-down"></i><span>Papiers</span>
				</a>
			</div>
			<ul class="subnav-menu">
				<li><a href="#">Assurance</a>
				</li>
				<li><a href="#">Visite technique</a>
				</li>
				<li><a href="#">Vignette</a>
				</li>
			</ul>
		</div>
		<div class="subnav">
			...
			<div class="page-header">
				...
				<div class="pull-right">
					<ul class="minitiles">
						...
						<li class='red'><a href="#"><i class="icon-cogs"></i> </a>
						</li>
