	...
	<div id="left">
		...
		<div class="subnav">
			<div class="subnav-title">
				<a href="#" class='toggle-subnav'><i class="icon-angle-down"></i><span>Content</span>
				</a>
			</div>
		...
		<div class="subnav">
			<div class="subnav-title">
				<a href="#" class='toggle-subnav'><i class="icon-angle-down"></i><span>Plugins</span>
				</a>
			</div>
			<ul class="subnav-menu">
		...
		<div class="subnav">
			<div class="subnav-title">
				<a href="#" class='toggle-subnav'><i class="icon-angle-down"></i><span>Settings</span>
				</a>
			</div>
			<ul class="subnav-menu">
		...
		<div class="container-fluid">
			<div class="page-header">
				...
				<div class="pull-right">
					<ul class="minitiles">
						<li class='teal'><a href="#"><i class="icon-inbox"></i>
						</a></li>
						<li class='red'><a href="#"><i class="icon-cogs"></i>
						</a></li>
						<li class='lime'><a href="#"><i class="icon-globe"></i>
						</a></li>
					</ul>
					<ul class="stats">
					...
					<div class="box">
						<div class="box-title">
							...
							<div class="actions">
								...
								</a> <a href="#" class="btn btn-mini content-remove"><i
									class="icon-remove"></i>
					...
					<div class="box">
						...
						<div class="box-content nopadding scrollable" data-height="350"
							...
							<ul class="messages">
								<li class="left">
									<div class="image">
										<img src="jsp/img/demo/user-1.jpg" alt="">
									</div>
									<div class="message">
								...
								<li class="right">
									<div class="image">
										<img src="jsp/img/demo/user-2.jpg" alt="">
									</div>
									<div class="message">
								...
								<li class="typing"><span class="name">John Doe</span> is
									typing <img src="jsp/img/loading.gif" alt=""></li>
								<li class="insert">
					...
					<div class="box box-color box-bordered">
						...
						<div class="box-content nopadding scrollable" data-height="300"
							...
							<table class="table table-user table-nohead">
								<tbody>
									<tr class="alpha">
										<td class="alpha-val"><span>B</span></td>
										<td colspan="2"></td>
									</tr>
									<tr>
										<td class='img'><img src="jsp/img/demo/user-1.jpg" alt="">
										</td>
									...
									<tr>
										<td class='img'><img src="jsp/img/demo/user-2.jpg" alt="">
										</td>
									...
									<tr class="alpha">
										<td class="alpha-val"><span>D</span></td>
										<td colspan="3"></td>
									</tr>
									<tr>
										<td class='img'><img src="jsp/img/demo/user-3.jpg" alt="">
										</td>
									...
									<tr>
										<td class='img'><img src="jsp/img/demo/user-4.jpg" alt="">
										</td>
									...
									<tr class="alpha">
										<td class="alpha-val"><span>H</span></td>
										<td colspan="3"></td>
									</tr>
									<tr>
										<td class='img'><img src="jsp/img/demo/user-3.jpg" alt="">
									...
									<tr class="alpha">
										<td class="alpha-val"><span>J</span></td>
										<td colspan="3"></td>
									</tr>
									<tr>
										<td class='img'><img src="jsp/img/demo/user-5.jpg" alt="">
										</td>
									...
									<tr>
										<td class='img'><img src="jsp/img/demo/user-6.jpg" alt="">
										</td>
										<td class='user'>John Doe</td>
										<td class='icon'><a href="#" class='btn'><i
												class="icon-search"></i>
									...
									<tr class="alpha">
										<td class="alpha-val"><span>L</span></td>
										<td colspan="3"></td>
									</tr>
									<tr>
										<td class='img'><img src="jsp/img/demo/user-5.jpg" alt="">
									...
									<tr class="alpha">
										<td class="alpha-val"><span>M</span></td>
										<td colspan="3"></td>
									</tr>
									<tr>
										<td class='img'><img src="jsp/img/demo/user-1.jpg" alt="">
									...
									<tr class="alpha">
										<td class="alpha-val"><span>O</span></td>
										<td colspan="3"></td>
									</tr>
									<tr>
										<td class='img'><img src="jsp/img/demo/user-1.jpg" alt="">
									...
									<tr class="alpha">
										<td class="alpha-val"><span>P</span></td>
										<td colspan="3"></td>
									</tr>
									<tr>
										<td class='img'><img src="jsp/img/demo/user-1.jpg" alt="">
				...
				<div class="span6">
					<div class="box box-color box-bordered green">
						<div class="box-title">
							...
							<div class="actions">
								<a href="#" class="btn btn-mini custom-checkbox checkbox-active">Automatic
						...
						<div class="box-content nopadding scrollable" data-height="400"
							...
							<table class="table table-nohead" id="randomFeed">
								<tbody>
									<tr>
										<td><span class="label"><i class="icon-plus"></i>
										</span> <a href="#">John Doe</a> added a new photo</td>
									</tr>
									<tr>
